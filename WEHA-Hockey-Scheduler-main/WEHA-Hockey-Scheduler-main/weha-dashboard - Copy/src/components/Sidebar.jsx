    ...
    `}>
      ...
      <div>
        ...
        <nav className="flex flex-col gap-4">
          ...
          <Link to="/admin/calendar-manager" className="text-gray-300 hover:text-white transition" onClick={onClose}>Calendar Manager</Link>
      ...
      {/* Logout confirmation modal — rendered in a portal-like fixed overlay so
          it appears above everything regardless of sidebar z-index */}
      {showConfirm && (
