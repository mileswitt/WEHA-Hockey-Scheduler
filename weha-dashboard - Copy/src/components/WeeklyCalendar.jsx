...
// Hide day columns that have no events so active days get more horizontal space.
// Only kicks in when at least 2 columns would be hidden (meaningful gain).
...
// Compute the tightest slot window that covers all events, with padding.
// Falls back to a sensible default when there are no events.
